...
public class PitchRentalDetailEntity extends BaseEntity {
    ...
    public Integer getPitchQuantity() { return pitchQuantity; }
    public void setPitchQuantity(Integer pitchQuantity) { this.pitchQuantity = pitchQuantity; }
