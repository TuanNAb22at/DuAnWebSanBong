...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    } // tìm kiếm user thông qua user name
    @Bean
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .hasRole("MANAGER")//phải được đăng nhập rồi
                .antMatchers("/admin/**").hasAnyRole("MANAGER","STAFF")//phải được đăng nhập rồi
                .antMatchers("/login", "/resource/**", "/trang-chu", "/api/**").permitAll()// không cần đăng nhập cũng vào được
                .and()
